...
import com.nesterenko.authorsshop.Adapter.MessageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MessageActivity.this, MessageFragment.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });

        recyclerView = findViewById(R.id.recycler_send);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity.this, "Вы не написали сообщение", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
