...
public class ProductAdapterMy extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private List<Product> dataset;
    private ProductClickListener listener;

    public ProductAdapterMy(List<Product> dataset) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = layoutInflater.inflate(R.layout.listitem_new_contacts_my, viewGroup, false);
