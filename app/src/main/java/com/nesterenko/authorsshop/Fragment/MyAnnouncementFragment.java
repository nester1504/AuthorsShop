...
import com.nesterenko.authorsshop.Activity.ContentActivity;
import com.nesterenko.authorsshop.Adapter.ProductAdapterMy;
...
public class MyAnnouncementFragment extends Fragment implements ProductAdapterMy.ProductClickListener {
    private List<Product> list_product;
    private ProductAdapterMy adapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new ProductAdapterMy(list_product);
        adapter.setItemClickListener((ProductAdapterMy.ProductClickListener) this);
