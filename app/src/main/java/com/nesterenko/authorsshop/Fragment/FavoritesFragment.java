...
import com.nesterenko.authorsshop.Activity.AnnouncementActivity;
import com.nesterenko.authorsshop.Product;
import com.nesterenko.authorsshop.Adapter.ProductAdapter;
import com.nesterenko.authorsshop.R;

import java.util.ArrayList;
import java.util.List;

public class FavoritesFragment extends Fragment implements ProductAdapter.ProductClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        reference = database.getReference("favorite/" + login + "/")
